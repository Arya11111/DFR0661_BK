...
#define WIFI_WLAN_DEBUG  rt_kprintf

class WiFiClass : public WiFiGenericClass, public WiFiSTAClass, public WiFiAPClass, public WiFiScanClass
{
public:
  using WiFiGenericClass::channel;//信道

    using WiFiSTAClass::SSID;
    using WiFiSTAClass::RSSI;//信号强度
